...
print("\n▶ 7-ELEVEN 전국 매장 크롤링 시작 (Supabase)...")
all_stores = crawl_all_stores(session)

update_locations_meta(STORE_NAME, len(all_stores), meta_key=META_KEY)
print(f"\n✅ 7-ELEVEN 매장 Supabase 저장 완료. (총 {len(all_stores)}개)")
